...
public class Converter {
	...
	public void initMessageInfo() {
		...
		msgdat.put("0050", new MessageType("0050", 4, "Rear Hub", new SubMessage[] {new SubMessage("Suspension Position RL", false, 0.012207, "mm"), new SubMessage("Suspension Position RR", false, 0.0148866, "mm")}));
		msgdat.put("0060", new MessageType("0060", 4, "Front Hub", new SubMessage[] {new SubMessage("Suspension Position FR", false, 0.012207, "mm"), new SubMessage("Suspension Position FL", false, 0.012207, "mm")}));
		msgdat.put("0070", new MessageType("0070", 8, "Accelerometer", new SubMessage[] {new SubMessage("Yaw Rate", true, 0.005, "deg/sec"), new SubMessage("Reserved", true, 1, ""), new SubMessage("Acceleration Y Axis", true, 0.0001274, "g"), new SubMessage("Unused", true, 1, "")}));
		msgdat.put("0080", new MessageType("0080", 8, "Accelerometer", new SubMessage[] {new SubMessage("Yaw Acceleration", true, 0.0125, "deg/sec^2"), new SubMessage("Reserved", true, 1, ""), new SubMessage("Acceleration x Axis", true, 0.0001274, "g"), new SubMessage("Unused", true, 1, "")}));
